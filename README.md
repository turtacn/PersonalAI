...
| **Chasi-SREagent**    | [https://github.com/turtacn/chasi-sreagent](https://github.com/turtacn/chasi-sreagent) | **中文：**基于大型语言模型的智能 SRE 代理，在 Kubernetes 多租户环境中实现自动化诊断、建议与问题分析。<br>**EN:** LLM-powered SRE agent automating diagnostics and decision-making in multi-tenant Kubernetes environments, enhancing observability and resilience.                                                                                                                                                                              |
