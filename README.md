...
| 项目名称                  | 项目链接                                                                                   | 项目简介（中英）                                                                                                                                                                                                                                                                                                                                                                                                    |
| --------------------- | -------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **KubeStack-AI**         | [https://github.com/turtacn/kubestack-ai](https://github.com/turtacn/kubestack-ai)           | **中文**：UniModel 是一个统一的、AI驱动的命令行助手，用于诊断、管理和优化运行在Kubernetes和裸机环境中的整个中间件堆栈。<br>**EN:** KubeStack-AI is a unified, AI-powered command-line assistant for diagnosing, managing, and optimizing the entire middleware stack running on Kubernetes and bare-metal environments. |
