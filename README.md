...
| 序号    | 项目名称                                                                                                         | 项目简介（中英）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ----- | ------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🆕 29 | [**OpenEAAP**](https://github.com/turtacn/OpenEAAP "https://github.com/turtacn/OpenEAAP")                       | **中文**：OpenEAAP 旨在解决企业在多个产品和复杂场景中部署 AI Agent 能力时面临的关键集成挑战。与单体化平台不同，OpenEAAP 提供了一个模块化、轻量级、高度可集成的基础设施。<br>**EN:** OpenEAAP is designed to solve the critical integration challenge faced by enterprises deploying AI Agent capabilities across multiple products and complex scenarios. Unlike monolithic platforms, it provides a modular, lightweight, and highly integrable foundation.                                                                                                                                                      |
